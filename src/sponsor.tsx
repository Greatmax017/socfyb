            ...
            <div className='relative w-full bg-[#000406] py-8 px-8 md:py-12 md:px-12 lg:py-28 lg:px-28 rounded-2xl'>
                ...
                <div className='z-[2] relative flex flex-col lg:flex-row gap-5 lg:gap-10 items-center lg:justify-between'>
                    <div className='text-white' >
                        ...
                        We envision a future where our collective efforts drive 
                        Partner with us and help shape the future of technology. Your support can make a significant impact</p>
                    </div>


                    <div className='w-full max-lg:mt-5 flex items-center justify-center'>
                    <button className='max-lg:w-full bg-primary-blue text-white py-4 px-5 lg:py-5 lg:px-28 rounded-3xl transition duration-500 hover:bg-primary-purple'>Get in touch</button>
                    </div>
                </div>
            </div>
        </div>
